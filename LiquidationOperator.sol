...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    function operate(uint256 debtUSDT) external {
    ...
    function uniswapV2Call(
        ...
        uint repay_WETH = getAmountIn(debtToCover = 2000, reserve_WBTC_Pool1, reserve_USDT_Pool1);
        WETH.transfer(address(uniswapV2Pair_WBTC_USDT), repay_WETH);
